...
import com.flange.store.console.dao.OmsOrderDao;
import com.flange.store.console.dao.OmsOrderOperateHistoryDao;
...
import com.flange.store.mapper.OmsOrderOperateHistoryMapper;
...
public class OmsOrderServiceImpl implements OmsOrderService {
    ...
    @Override
    public int close(List<String> ids, String note) {
    ...
    @Override
    public OmsOrderDetail detail(String id) {
