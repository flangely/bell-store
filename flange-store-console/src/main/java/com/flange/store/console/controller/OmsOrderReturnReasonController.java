...
import com.flange.store.console.service.OmsOrderReturnReasonService;
...
public class OmsOrderReturnReasonController {
    ...
    @ResponseBody
    public Object update(@PathVariable String id, @RequestBody OmsOrderReturnReason returnReason) {
