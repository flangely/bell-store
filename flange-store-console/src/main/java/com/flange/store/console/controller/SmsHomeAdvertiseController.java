...
import com.flange.store.console.service.SmsHomeAdvertiseService;
...
public class SmsHomeAdvertiseController {
    ...
    @ResponseBody
    public Object updateStatus(@PathVariable String id, Integer status) {
    ...
    @ResponseBody
    public Object update(@PathVariable String id, @RequestBody SmsHomeAdvertise advertise) {
